    ...
    public function run(): void
    {
        $configuraciones = [
            ...
            [
                ...
                'valor'       => 'Farmacia & Droguería FarmaBien S.A.',
                'tipo'        => 'string',
                'grupo'       => 'empresa',
            ...
            [
                'clave'       => 'empresa_ruc',
                'valor'       => 'J0310000089215',
                'tipo'        => 'string',
                'grupo'       => 'empresa',
                'descripcion' => 'Número de RUC fiscal (Nicaragua)',
            ],
            [
                'clave'       => 'empresa_telefono',
                'valor'       => '+505 2255-8899 / +505 8888-1234',
                'tipo'        => 'string',
                'grupo'       => 'empresa',
            ...
            [
                'clave'       => 'empresa_email',
                'valor'       => 'contacto@farmabien.com.ni',
                'tipo'        => 'string',
                'grupo'       => 'empresa',
            ...
            [
                ...
                'valor'       => 'De los semáforos de Plaza España 2c. al sur, Managua, Nicaragua',
                'tipo'        => 'string',
                'grupo'       => 'empresa',
