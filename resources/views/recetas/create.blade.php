...
<div x-data="recetaFormData()"
    ...
    <div class="flex items-center justify-between gap-2">
        <div><h1 class="text-lg sm:text-xl font-bold text-slate-900 dark:text-white">Registrar Receta Medica</h1><p class="text-xs text-slate-500 dark:text-slate-400">Completa los datos del paciente, medico prescriptor y los medicamentos.</p></div>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-300 dark:border-slate-800 shadow-md p-4 space-y-4 animate-fadeIn">
        <div class="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800 bg-slate-100/80 dark:bg-slate-800/60 -mx-4 -mt-4 p-3 rounded-t-2xl">
            <div class="flex items-center space-x-2">
                ...
                <span class="text-xs font-extrabold text-slate-800 dark:text-slate-200 uppercase tracking-wide">NUEVA RECETA MEDICA</span>
            </div>
            <div class="flex items-center space-x-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
            ...
            <div class="p-3.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-800/30 space-y-2.5">
                ...
                <div><label class="block text-[10px] font-semibold text-slate-500 mb-0.5">Nombre Paciente *</label><input type="text" name="paciente_nombre" value="{{ old('paciente_nombre') }}" required placeholder="Nombre completo..." class="w-full px-2 py-1.5 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs text-slate-900 dark:text-white focus:ring-1 focus:ring-emerald-500"></div>
                <div class="grid grid-cols-2 gap-1.5">
                    <div><label class="block text-[10px] font-semibold text-slate-500 mb-0.5">DNI</label><input type="text" name="paciente_documento" value="{{ old('paciente_documento') }}" placeholder="DNI..." class="w-full px-2 py-1.5 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs text-slate-900 dark:text-white focus:ring-1 focus:ring-emerald-500"></div>
            ...
            <div class="p-3.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-800/30 space-y-2.5">
                ...
                <div><label class="block text-[10px] font-semibold text-slate-500 mb-0.5">Nombre Medico *</label><input type="text" name="medico_nombre" value="{{ old('medico_nombre') }}" required placeholder="Dr. ..." class="w-full px-2 py-1.5 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs text-slate-900 dark:text-white focus:ring-1 focus:ring-emerald-500"></div>
                <div><label class="block text-[10px] font-semibold text-slate-500 mb-0.5">CMP *</label><input type="text" name="medico_colegiatura" value="{{ old('medico_colegiatura') }}" required placeholder="CMP-12345" class="w-full px-2 py-1.5 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs text-slate-900 dark:text-white focus:ring-1 focus:ring-emerald-500"></div>
                <div><label class="block text-[10px] font-semibold text-slate-500 mb-0.5">Especialidad</label><input type="text" name="medico_especialidad" value="{{ old('medico_especialidad') }}" placeholder="Med. General..." class="w-full px-2 py-1.5 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs text-slate-900 dark:text-white focus:ring-1 focus:ring-emerald-500"></div>
                <div><label class="block text-[10px] font-semibold text-slate-500 mb-0.5">Institucion</label><input type="text" name="institucion_salud" value="{{ old('institucion_salud') }}" placeholder="Hospital..." class="w-full px-2 py-1.5 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs text-slate-900 dark:text-white focus:ring-1 focus:ring-emerald-500"></div>
            </div>
            ...
            <div class="p-3.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-800/30 space-y-2.5">
                ...
                <div><label class="block text-[10px] font-semibold text-slate-500 mb-0.5">N Receta *</label><input type="text" name="numero_receta" value="{{ old('numero_receta') }}" required placeholder="RX-001..." class="w-full px-2 py-1.5 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs text-slate-900 dark:text-white focus:ring-1 focus:ring-emerald-500"></div>
                ...
                <div><label class="block text-[10px] font-semibold text-slate-500 mb-0.5">Emision *</label><input type="date" name="fecha_emision" value="{{ old('fecha_emision', now()->toDateString()) }}" required class="w-full px-2 py-1.5 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs text-slate-900 dark:text-white focus:ring-1 focus:ring-emerald-500"></div>
                <div><label class="block text-[10px] font-semibold text-slate-500 mb-0.5">Vencimiento</label><input type="date" name="fecha_vencimiento" value="{{ old('fecha_vencimiento') }}" class="w-full px-2 py-1.5 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs text-slate-900 dark:text-white focus:ring-1 focus:ring-emerald-500"></div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="text" name="medico_nombre" value="{{ old('medico_nombre') }}" required placeholder="Dr. Juan Perez..." class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition @error('medico_nombre') border-rose-500 @enderror">
