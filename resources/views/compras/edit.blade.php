...
@keydown.window="if ($event.key === 'Escape' && formLayout === 'compact') { window.location.href = '{{ route('compras.show', $compra) }}'; }"
                    ...
                    <div class="lg:col-span-4 space-y-3">
                        <div class="bg-white dark:bg-slate-900 rounded-xl p-3.5 border border-slate-300 dark:border-slate-800 shadow-xs space-y-3">
                            <div class="flex items-center space-x-2 pb-2 border-b border-slate-200 dark:border-slate-800">
                                ...
                                <h3 class="text-xs font-bold uppercase text-slate-800 dark:text-slate-200 tracking-wider">1. Cabecera y Motivo</h3>
                            </div>

                            <!-- Motivo Modificación (Obligatorio) -->
                            <div>
                                <label class="block text-[11px] font-bold text-amber-700 dark:text-amber-400 mb-1">
                                ...
                                <textarea name="motivo_modificacion" 
                                          ...
                                          minlength="5"
                                          rows="2"
                                          placeholder="Ej: Corrección en cantidad de lote o ajuste de factura del proveedor..."
                                          class="w-full px-2.5 py-1.5 bg-amber-50/40 dark:bg-slate-800 border border-amber-300 dark:border-amber-700 rounded-lg text-xs text-slate-900 dark:text-white focus:ring-2 focus:ring-amber-500"></textarea>
                            </div>
                        ...
                        <div class="bg-slate-900 text-white rounded-xl p-3.5 border border-slate-800 shadow-xs space-y-2.5">
                            <h4 class="text-[11px] font-bold uppercase tracking-wider text-slate-400">Resumen Actualizado</h4>
                            ...
                            <div class="pt-2 border-t border-slate-800 flex justify-between items-baseline">
                                <span class="text-xs font-semibold text-slate-300">Total Recalculado:</span>
                            ...
                            <div class="pt-2 flex items-center space-x-2">
                                ...
                                <button type="submit" 
                                        ...
                                        class="flex-2 py-2 rounded-lg bg-amber-600 hover:bg-amber-500 disabled:opacity-50 text-white text-xs font-bold shadow-xs transition flex items-center justify-center space-x-1 cursor-pointer">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-5 border border-slate-300 dark:border-slate-800 shadow-xs space-y-4">
                    <div class="flex items-center space-x-3 pb-3 border-b border-slate-200 dark:border-slate-800">
                        <div class="w-9 h-9 rounded-xl bg-amber-100 dark:bg-amber-950/60 text-amber-700 dark:text-amber-400 flex items-center justify-center font-bold text-sm">
                            1
                        </div>
                        <div>
                            <h3 class="text-sm font-bold text-slate-900 dark:text-white">Datos de la Factura y Razón del Cambio</h3>
                            <p class="text-xs text-slate-500 dark:text-slate-400">Especifique el motivo de la modificación para asegurar la trazabilidad.</p>
                        </div>
                    </div>

                    <!-- Motivo Modificación -->
                    <div>
                        <label class="block text-xs font-bold text-amber-800 dark:text-amber-300 mb-1">
                            Motivo de la Modificación <span class="text-rose-500">*</span>
                        </label>
                        <textarea name="motivo_modificacion" 
                                  x-model="formData.motivo_modificacion" 
                                  ...
                                  class="w-full px-3 py-2 bg-amber-50/40 dark:bg-slate-800 border border-amber-300 dark:border-amber-700 rounded-xl text-xs text-slate-900 dark:text-white focus:ring-2 focus:ring-amber-500"></textarea>
                    </div>
                    ...
                    <div class="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-500 dark:text-slate-400">Modifique cantidades, costos o fechas de vencimiento de cada lote.</p>
                            </div>
                        </div>
                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-5 border border-slate-300 dark:border-slate-800 shadow-xs flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div class="flex items-center space-x-3 w-full md:w-auto">
                        ...
                        <button type="submit" 
                            ...
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            <span>Guardar y Generar Nueva Versión</span>
                        </button>
                    </div>
                </div>
