...
<div class="space-y-5" x-data="{
    ...
    <div class="hidden print:block border-b-2 border-emerald-600 pb-3 mb-4">
        <div class="flex items-start justify-between">
            ...
            <div class="text-right">
                <div class="inline-block border border-emerald-600 bg-emerald-50 px-3 py-1.5 rounded text-center">
                    <p class="text-xs font-bold text-emerald-800">REPORTE DE VENTAS E INGRESOS</p>
        ...
        <div class="mt-2 text-xs bg-slate-100 p-2 rounded flex items-center justify-between">
            ...
            <span><strong>Método Pago:</strong> {{ ucfirst($metodoPago ?: 'Todos') }}</span>
            <span><strong>Cajero:</strong> {{ $cajeroId ? (\App\Models\User::find($cajeroId)?->name ?? 'N/A') : 'Todos' }}</span>
            <span><strong>Total Ventas:</strong> {{ number_format($cantidadVentas) }}</span>
        </div>
    </div>
