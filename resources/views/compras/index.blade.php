...
@section('page-actions')
    <div>
        ...
        <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">
            Registra y controla todas las compras de inventario
        </p>
    </div>
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="p-6">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="mt-2 text-3xl font-bold text-slate-900 dark:text-white">{{ $compras->total() }}</p>
                    </div>
            ...
            <div class="p-6">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="mt-2 text-3xl font-bold text-green-600 dark:text-green-400">{{ $compras->where('estado', 'recibida')->count() }}</p>
                    </div>
            ...
            <div class="p-6">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="mt-2 text-3xl font-bold text-red-600 dark:text-red-400">{{ $compras->where('estado', 'anulada')->count() }}</p>
                    </div>
        ...
        <!-- Monto Total -->
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 dark:from-purple-600 dark:to-purple-700 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
            <div class="p-6">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <p class="text-sm font-semibold text-purple-100 uppercase tracking-wide">Monto Total</p>
                        <p class="mt-2 text-3xl font-bold text-white">S/ {{ number_format($compras->where('estado', 'recibida')->sum('total'), 2) }}</p>
                    </div>
            ...
            <form id="formAnular" method="POST">
                ...
                <div class="p-6">
                    ...
                    <p class="mt-2 text-xs text-slate-500 dark:text-slate-400">
                        Explica brevemente por qué se anula esta compra
                    </p>
                </div>
