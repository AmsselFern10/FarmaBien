...
@section('header')
    <div class="flex items-start justify-between gap-4">
        <div>
            <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Registrar Nueva Receta Médica</h2>
            <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">Completa los datos obligatorios y agrega información clínica opcional.</p>
        </div>
