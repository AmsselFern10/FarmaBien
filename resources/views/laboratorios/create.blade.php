...
<div x-data="{
    ...
    formData: (window.farmaGetDraft ? window.farmaGetDraft('{{ request()->getPathInfo() }}', {
        ...
        pais_origen: @js(old('pais_origen', '')),
    ...
    limpiarFormulario() {
        this.formData = { nombre: '', codigo: '', pais_origen: '', contacto: '', telefono: '', email: '', activo: true };
...
class="space-y-4 transition-all duration-200">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        <div>
            <h1 class="text-lg sm:text-xl font-bold text-slate-900 dark:text-white">Registrar Nuevo Laboratorio Fabricante</h1>
    ...
    <!-- Form -->
    <form x-ref="laboratorioForm" method="POST" action="{{ route('laboratorios.store') }}">
        @csrf
            ...
            <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-300 dark:border-slate-800 shadow-md p-4 space-y-4 animate-fadeIn">
                ...
                <div class="flex items-center justify-between pb-3 border-b border-slate-300 dark:border-slate-800 bg-slate-100/80 dark:bg-slate-800/60 -mx-4 -mt-4 p-3 rounded-t-2xl">
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-xs font-extrabold text-slate-800 dark:text-slate-200 uppercase tracking-wide">FICHA RÁPIDA DE LABORATORIO</span>
                    ...
                    <div class="p-3.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/40 dark:bg-slate-800/30 space-y-3">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   required 
                                   autofocus
                                   placeholder="Ej. Laboratorios Pfizer S.A., Genfar S.A..." 
