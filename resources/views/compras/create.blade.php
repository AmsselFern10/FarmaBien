...
@section('content')
<form action="{{ route('compras.store') }}" method="POST" id="formCompra" class="max-w-7xl mx-auto space-y-6">
    @csrf
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500 dark:text-slate-400">Agrega los productos con sus lotes</p>
                    </div>
                </div>
                <button type="button" 
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700" id="tablaProductos">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider">N° Lote</th>
                        ...
                        <th class="px-4 py-3 text-right text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider">P. Unitario</th>
                        ...
                        <th class="px-4 py-3 text-center text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider w-16">
        ...
        <div id="mensajeSinProductos" class="p-12 text-center bg-gray-50 dark:bg-gray-800/50">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-purple-50 to-white dark:from-gray-800 dark:to-gray-800/50">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500 dark:text-slate-400">Totales calculados automáticamente</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <!-- Total -->
                <div class="md:col-span-3 relative overflow-hidden bg-gradient-to-br from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 rounded-xl p-6 border border-blue-400 dark:border-blue-500">
                    <div class="relative z-10">
                        ...
                        <p class="text-sm text-blue-100 mt-2">Incluye todos los productos agregados</p>
                    </div>
    ...
    row.innerHTML = `
        <td class="px-4 py-3">
            <select name="productos[${index}][producto_id]" 
                    class="w-full min-w-[200px] rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm transition-colors duration-200"
        ...
        <td class="px-4 py-3">
            <input type="text" 
                   ...
                   class="w-full min-w-[120px] rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm font-mono transition-colors duration-200"
                   required>
        </td>
        <td class="px-4 py-3">
            <input type="date" 
                   ...
                   min="{{ date('Y-m-d') }}"
                   class="w-full min-w-[140px] rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm transition-colors duration-200"
                   required>
        </td>
        <td class="px-4 py-3">
            <input type="number" 
                   ...
                   min="1"
                   value="1"
                   class="w-full min-w-[80px] rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm text-right transition-colors duration-200"
        ...
        <td class="px-4 py-3">
            <div class="relative">
                ...
                <input type="number" 
                       ...
                       min="0"
                       value="0"
                       class="w-full min-w-[100px] pl-8 pr-3 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm text-right transition-colors duration-200"
                       onchange="calcularSubtotalFila(${index})"
                       required>
            </div>
        </td>
...
window.addEventListener('load', function() {
    // Opcional: descomentar para agregar automáticamente
    // agregarProducto();
});
</script>
@endpush
