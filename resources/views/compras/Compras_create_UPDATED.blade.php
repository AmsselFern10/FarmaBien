...
<div class="pt-3 border-t border-gray-200 dark:border-gray-700 space-y-2.5">
    {{-- Mantenerme aquí --}}
    <div class="flex items-center justify-end">
        <label class="inline-flex items-center gap-2 text-sm text-slate-700 dark:text-slate-200 select-none cursor-pointer">
            <input id="mantener_en_pantalla" name="mantener_en_pantalla" type="checkbox" value="1"
                   class="rounded border-gray-300 dark:border-gray-600 text-blue-600 focus:ring-blue-500"
                   @checked(old('mantener_en_pantalla'))>
            <span class="font-medium">Mantenerme aquí</span>
        </label>
    </div>

    {{-- Acción: guardar / facturar --}}
    <input type="hidden" name="accion" id="accion_compra" value="{{ old('accion', 'guardar') }}">
    ...
    <div class="flex flex-col sm:flex-row items-stretch gap-2">
        ...
        <div class="relative w-full">
            <div class="inline-flex w-full rounded-xl shadow-sm overflow-hidden">
                <button type="button" onclick="submitCompra()"
                        class="flex-1 inline-flex items-center justify-center px-6 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold transition-all hover:shadow-md">
                    <span id="labelAccionGuardarCompra" class="inline-flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                        <span class="uppercase tracking-wide">Guardar compra</span>
                    </span>
                    <span id="labelAccionFacturarCompra" class="hidden inline-flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 9V2h12v7M6 18h12M6 14h12M8 22h8"></path>
                        </svg>
                        <span class="uppercase tracking-wide">Guardar y facturar</span>
                    </span>
                </button>

                <button type="button" onclick="toggleAccionCompraMenu()"
                        class="inline-flex items-center justify-center px-3 bg-blue-700 hover:bg-blue-800 text-white">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div id="menuAccionCompra" class="absolute right-0 mt-2 w-64 origin-top-right rounded-xl bg-white dark:bg-gray-800 shadow-xl ring-1 ring-black/5 dark:ring-white/10 border border-gray-200 dark:border-gray-700 hidden z-50">
                <div class="py-1">
                    <button type="button" onclick="setAccionCompra('guardar')"
                            class="w-full flex items-center gap-3 px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <button type="button" onclick="setAccionCompra('facturar')"
                            class="w-full flex items-center gap-3 px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-gray-50 dark:hover:bg-gray-700">
                        <svg class="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 9V2h12v7M6 18h12M6 14h12M8 22h8"></path>
                        </svg>
                        <span class="font-semibold">Guardar y facturar</span>
                    </button>
                </div>
            </div>
        </div>
