        ...
        <div class="p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-slate-900 dark:text-white">{{ $proveedores->total() }}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-green-600 dark:text-green-400">{{ $proveedores->where('activo', true)->count() }}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-red-600 dark:text-red-400">{{ $proveedores->where('activo', false)->count() }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-slate-600 dark:text-slate-400">En esta página</p>
                    <p class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ $proveedores->count() }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors {{ !$proveedor->activo ? 'opacity-60' : '' }}">
                    
                    <!-- Proveedor -->
                    <td class="px-6 py-4">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 h-12 w-12 flex items-center justify-center rounded-lg bg-purple-100 dark:bg-purple-900/30">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm font-mono font-semibold text-slate-900 dark:text-white bg-slate-100 dark:bg-slate-700 px-3 py-1 rounded inline-block">
                            {{ $proveedor->ruc }}
                        </div>
                    </td>
                ...
                <tr>
                    <td colspan="5" class="px-6 py-16 text-center">
                        ...
                        <p class="mt-4 text-slate-500 dark:text-slate-400 font-medium">No se encontraron proveedores</p>
                        @can('crear proveedores')
                        <a href="{{ route('proveedores.create') }}" 
