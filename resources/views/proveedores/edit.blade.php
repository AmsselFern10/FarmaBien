...
@section('page-actions')
    ...
    <div class="flex gap-3">
        <a href="{{ route('proveedores.show', $proveedor) }}" 
           class="inline-flex items-center px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-lg transition-colors duration-200 shadow-sm">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" 
                                   ...
                                   maxlength="11"
                                   pattern="[0-9]{11}"
                                   class="block w-full pl-10 pr-3 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-slate-900 dark:text-white font-mono focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('ruc') border-red-500 dark:border-red-500 @enderror"
                                   required>
                        </div>
                        @error('ruc')
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="direccion" 
                                      id="direccion"
                                      rows="3"
                                      class="block w-full pl-10 pr-3 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('direccion', $proveedor->direccion) }}</textarea>
                        </div>
                        @error('direccion')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea name="observaciones" 
                                  id="observaciones"
                                  rows="4"
                                  class="block w-full px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('observaciones', $proveedor->observaciones) }}</textarea>
                        @error('observaciones')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div class="flex items-center space-x-2 text-slate-600 dark:text-slate-400">
                        ...
                        <span>{{ $proveedor->updated_at->format('d/m/Y H:i') }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div>
                @if($proveedor->activo)
                    <form action="{{ route('proveedores.destroy', $proveedor) }}" 
                        ...
                        @method('DELETE')
                        <button type="submit" 
                                class="inline-flex items-center px-6 py-3 bg-red-500 hover:bg-red-600 text-white font-semibold rounded-lg transition-colors duration-200 shadow-sm">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
