...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            ...
            <h1 class="text-xl font-bold text-slate-900 dark:text-white">Editar Laboratorio: {{ $laboratorio->nombre }}</h1>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('laboratorios.update', $laboratorio) }}" class="space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="codigo" 
                           name="codigo" 
                           value="{{ old('codigo', $laboratorio->codigo) }}" 
                ...
                <div class="md:col-span-1">
                    ...
                    <input type="text" 
                           id="pais_origen" 
                           name="pais_origen" 
                           value="{{ old('pais_origen', $laboratorio->pais_origen) }}" 
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm">
            ...
            <label class="flex items-center space-x-3 cursor-pointer">
                <input type="checkbox" 
                       name="activo" 
                       value="1" 
                       {{ old('activo', $laboratorio->activo) ? 'checked' : '' }} 
