...
<div x-data="{
    ...
    formData: { producto_id: @js(old('producto_id','')), nombre: @js(old('nombre','')), descripcion: @js(old('descripcion','')), unidades: @js(old('unidades_por_presentacion',1)), precio_compra: @js(old('precio_compra','')), precio_venta: @js(old('precio_venta','')), codigo_barras: @js(old('codigo_barras','')), es_unidad_base: @js(old('es_unidad_base',false)?true:false), activo: @js(old('activo',1)?true:false), orden: @js(old('orden',0)) },
...
<div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-300 dark:border-slate-800 shadow-md p-4 space-y-4 animate-fadeIn">
    <div class="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800 bg-slate-100/80 dark:bg-slate-800/60 -mx-4 -mt-4 p-3 rounded-t-2xl">
        <div class="flex items-center space-x-2">
            ...
            <span class="text-xs font-extrabold text-slate-800 dark:text-slate-200 uppercase tracking-wide">NUEVA PRESENTACION</span>
